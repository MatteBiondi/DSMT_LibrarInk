...
add_test_() -> {"Insert", [
  ...
  {"Loan", [
    ?_assertEqual({succeed,ok}, librarink_mnesiaDB_fun:from_reservation_to_loan("federico", "CCC")),
    ?_assertEqual({succeed,ok}, librarink_mnesiaDB_fun:from_reservation_to_loan("matteo", "BBB")),
    ?_assertEqual({error,reservation_not_found}, librarink_mnesiaDB_fun:from_reservation_to_loan("federico", "DDD")),
